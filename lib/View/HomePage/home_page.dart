...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    firebaseService.getMessageCounts();
  }
                            ...
                            children: [
                              ...
                              CircleAvatar(
                                ...
                                child: Center(
                                  child: Text(
                                    firebaseService
                                            .messageCounts[index.toString()]
                                            ?.toString() ??
                                        "0", // Use the message count if available, or "0" as a default.
                                    style: const TextStyle(
                                      color: Colors.white,
                                      fontSize: 10,
                                    ),
                    ...
                    child: InkWell(
                      ...
                      child: Row(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl: controller.url.value ??
                                "", // Use a default value if url is null or empty
                            placeholder: (context, url) {
                              return const Center(
                                child: SizedBox(
                                  height: 15,
                            ...
                            errorWidget: (context, url, error) {
                              // Handle the case where there is an error loading the image
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              CircleAvatar(
                                ...
                                child: Center(
                                  child: Text(
                                    firebaseService.messageCounts[snapshot
                                                .child('phoneNumber')
                                                .value
                                                .toString()]
                                            ?.toString() ??
